...
class BARTScorer:
    def __init__(self, device='cuda:0', max_length=1024, checkpoint=None):
        ...
        self.tokenizer = T5Tokenizer.from_pretrained('/home/shesj/workspace/Data/PLM/T5_small')
        self.model = T5ForConditionalGeneration.from_pretrained('/home/shesj/workspace/Data/PLM/T5_small')
        self.model.eval()
    ...
    def score(self, srcs, tgts, batch_size=4,summary_level=False):
        ...
        for i in range(0, len(srcs), batch_size):
            ...
            try:
                src_list = ["summarize: " + i for i in src_list]
                with torch.no_grad():
