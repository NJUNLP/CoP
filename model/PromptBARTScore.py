...
class BARTScorer:
    def __init__(self, device='cuda:0', max_length=1024-Encoder_prefix_prompt_length-Encoder_inter_prompt_length, checkpoint='facebook/bart-large-cnn',PromptBART = False,Dev=False):
        ...
        if PromptBART:
            from model.promptBART import BartPromptForConditionalGeneration
            ...
            if Dev is False:
                ...
                #self.load("/home/shesj/workspace/Data/PLM/PromptBART/EXFewShot100_Shuffle_5+5.pth")
                #self.load("/home/shesj/workspace/Data/PLM/PromptBART/rebuildShuffle100+100.pth")
                self.load("/home/shesj/workspace/Data/PLM/PromptBART/Pesuo-Shuffle-100+100.pth")
                #self.load("/home/shesj/workspace/Data/PLM/PromptBART/FewShot300_Shuffle_5+5.pth")
